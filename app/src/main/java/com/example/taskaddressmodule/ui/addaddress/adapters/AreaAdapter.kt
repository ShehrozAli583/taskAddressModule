...
class AreaAdapter(context: Context, @LayoutRes private val layoutResource: Int, private val list: MutableList<AreasOfCities>) : ArrayAdapter<AreasOfCities>(context, layoutResource, list) {
    ...
    override fun getItem(p0: Int): AreasOfCities {
        return list[p0]
    }
